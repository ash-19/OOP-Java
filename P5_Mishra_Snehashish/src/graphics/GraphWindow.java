...
public class GraphWindow extends JFrame
{
    ...
    /**
     * Uses a JFileChooser to obtain a file of data that is used to update the
    ...
    private void loadData ()
    {
        ...
        if (chooser.showOpenDialog(this) == JFileChooser.APPROVE_OPTION)
        {
            ...
            try (Scanner dataSource = new Scanner(chooser.getSelectedFile()))
            {
                ...
                GraphingMethods.readTable(dataSource, column1, column2);

                // Add the unique categories to the category panel
                categoryPanel.removeAll();
                TreeSet<String> categories = new TreeSet<>(column1);
    ...
    private class CategoryArea extends JPanel
    {
        ...
        {
            Color chosen = JColorChooser.showDialog(this, "Choose a Color",
    ...
    private class DrawingArea extends JPanel
    {
        ...
        public void paintComponent (Graphics graphics)
        {
            ...
            if (categories.size() > 0)
            {
                ...
                ArrayList<Double> percentages = GraphingMethods.prepareGraph(
                        column1, column2, categories, getOperation());
                GraphingMethods.drawGraph(g, categories, percentages, colors,
                        pieChart.isSelected());
            }
        }
    }
